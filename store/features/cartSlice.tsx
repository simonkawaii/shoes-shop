...
export const cartSlice = createSlice({
    ...
    reducers: {
        addToCart:(state,action)=>{
            ...
            const itemIndex = cartItems.findIndex((item)=>{return item.id === action.payload.id})
...
export const { addToCart, removeFromCart, incrementItemInCart,modifyItemsInCart } = cartSlice.actions
